...
<b>NOTE:</b>
1. Clanzy Dᴇᴛᴇᴄᴛɪᴠᴇ Bᴏᴛ 😎 should have admin privillage.
...
2. Clanzy Dᴇᴛᴇᴄᴛɪᴠᴇ Bᴏᴛ 😎 supports buttons with any telegram media type.
3. Buttons should be properly parsed as markdown format

<b>URL buttons:</b>
<code>[Button Text](buttonurl:http://t.me/darkenclanzybot)</code>
